...
public class ArticleController {
    ...
    public Result getArticleInformation(@PathVariable int id) {
        ...
        return resultUtil.success("articleInfo", new ArticleInfoVo(article));
    }
    ...
    public Result getAllArticleInformation() {
        ...
        return resultUtil.success("articles", articlesResult);
    }
    ...
    public Result getAllArticleNumber() {
        ...
        return resultUtil.success("sum", sum);
    }
    ...
    public Result getArticleById(@PathVariable int id) {
        ...
        return resultUtil.success("article", new ArticleVo(article));
    }
